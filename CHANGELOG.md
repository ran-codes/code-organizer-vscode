...
<!-- 0.2.0 was tagged but never published: its package was rejected by the
     Marketplace secret scanner, which burned the version number. 0.2.1 is that
     release, with no functional differences. -->
